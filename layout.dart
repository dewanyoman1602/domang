      ...
      body: Center(
        ...
        child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                "Dewa Nyoman Budi Sayoga Pinatih", style: TextStyle(color: Colors.white, fontSize: 23),),
              Text(
                "1815051048",style: TextStyle(color: Colors.white,),),
              Card(
                child: Row(
                  children:<Widget> [
                    Expanded(
                      child: Card(
                          ...
                          child: Column (
                            children: <Widget>[Icon(Icons.my_location, size: 110, color: Colors.pink,),
                              Text('Klungkung',style: TextStyle(color: Colors.white, fontSize: 17.0,),)],
                          )
                      ),
                    ),
                      ...
                      child: Card(
                          ...
                          child: Column (
                            children: <Widget>[Icon(Icons.home, size: 110, color: Colors.pink,),
                              Text('KLungkung',style: TextStyle(color: Colors.white, fontSize: 17,),)],
                          )
                      ),
                    )
                  ],
